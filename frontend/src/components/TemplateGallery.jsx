...
const tabCategories = [
  "All", "Modern", "Minimal", "Classic", "Creative", "Professional", "Elegant",
];
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  color: isActive ? "#102a43" : "text.secondary", fontWeight: isActive ? "bold" : "medium",
                  transition: "color 0.2s ease", userSelect: "none",
                }}
              >
                {displayLabel}
                {isActive && (
                  <motion.div layoutId="underline" style={{ position: "absolute", bottom: -1, left: 0, right: 0, height: 3, backgroundColor: "#52b0c3", borderRadius: "3px 3px 0 0" }} />
                )}
              </Box>
            );
          })}
            ...
            >
              ...
              >
                {filteredTemplates.map((item) => (
                  <Box key={item.id}>
                    <TemplateCard item={item} onPreview={() => setPreviewItem(item)} />
                  </Box>
                ))}
              </Box>
            </motion.div>
          ...
          {previewItem && (
            <motion.div
              ...
              style={{
                ...
                backgroundColor: "rgba(15, 23, 42, 0.85)", backdropFilter: "blur(8px)", // Nền tối mờ sang trọng
            ...
            >
              ...
              <IconButton 
                ...
                sx={{ position: "fixed", top: 20, right: 30, color: "white", bgcolor: "rgba(255,255,255,0.1)", "&:hover": { bgcolor: "rgba(255,255,255,0.2)" } }}
              >
                <CloseIcon />
              </IconButton>
              ...
              <motion.div
                ...
                onClick={(e) => e.stopPropagation()} // Bấm vô cái CV thì KHÔNG bị đóng
